/* demo-data.js — seed data + date helpers for Agent Bora
...
export const SEED_MEETINGS = [
  {
    ...
    transcript: [
      ...
      { t: "02:48", speaker: "Mira Okonkwo", text: "Sequence it. Editor first, mobile beta right after GA." },
      {
        ...
        speaker: "Atlas",
        isAgent: true,
        text: "Logged. Mobile beta now starts after editor GA. I’ll also move the pricing experiment out — it depends on billing v2, which just slipped. Park it in Q4?",
      },
  ...
  {
    id: "m_design_crit",
    title: "Design Crit — Editor Canvas",
    date: "2026-05-22T19:00:00",
    durationMin: 41,
    platform: "meet",
    agentId: "ag_atlas",
    mode: "proactive",
    attendees: ["Mira Okonkwo", "Jun Park", "Sara Bloom", "Dev Raman"],
    spoke: 3,
    summary:
      "The team reviewed three directions for the collaborative editor canvas. Direction B — a focused, single-column writing surface with presence cues in the gutter — won the room. Atlas tracked the open question of how comments resolve and surfaced that it was raised twice without an owner, then assigned it.",
    highlights: [
    ...
    transcript: [
      ...
      { t: "09:12", speaker: "Sara Bloom", text: "Agreed, but how do comments resolve? We keep skipping that." },
      {
        ...
        speaker: "Atlas",
        isAgent: true,
        text: "That’s the second time comment resolution has come up with no owner. Sara, want me to put it on you to define, due before handoff?",
      },
  ...
  {
    id: "m_eng_standup",
    title: "Eng Planning — Sprint 19",
    date: "2026-05-20T16:00:00",
    durationMin: 29,
    platform: "teams",
    agentId: "ag_atlas",
    mode: "passive",
    attendees: ["Dev Raman", "Priya Nair", "Omar Diallo", "Atlas"],
    spoke: 1,
    summary:
      "Sprint 19 commits to the editor data model and the billing migration spike. Omar raised flakiness in the CI suite eating review time. The team agreed to timebox a fix. Atlas noted the billing spike has no acceptance criteria yet and flagged it before commit.",
    highlights: [
    ...
    transcript: [
      { t: "02:11", speaker: "Omar Diallo", text: "CI is failing randomly like a third of the time. It’s killing review velocity." },
      {
        ...
        speaker: "Atlas",
        isAgent: true,
        text: "Before we commit the billing spike — it has no acceptance criteria on the ticket. It’ll balloon. Want someone to write them first?",
      },
    ],
  },
  {
    ...
    agentId: "ag_atlas",
    mode: "proactive",
    attendees: ["Mira Okonkwo", "Lena Cho", "Finance — Raj"],
    spoke: 4,
    summary:
      "Prep for the May investor update. Net revenue retention is the headline at 118%. Lena and Raj aligned on framing the billing slip as a deliberate trade for SOC 2 readiness, which unlocks enterprise. Atlas pulled the three numbers that needed sources and listed them.",
    highlights: [
    ...
    transcript: [
      { t: "05:40", speaker: "Lena Cho", text: "The billing slip is going to get a question. We should get ahead of it." },
      {
        ...
        speaker: "Atlas",
        isAgent: true,
        text: "Three numbers in this deck don’t have a source attached yet — NRR, monthly burn, and Q3 pipeline. I’d lock those before it goes out. Want me to assign the source-check?",
      },
    ],
  },
];
...
export const SEED_AGENT_CHAT = {
  ag_atlas: [
    {
      role: "agent",
      text: "Morning, Mira. You’ve got the Q3 Roadmap Lock in 40 minutes. Want the one-line state of each bet before you walk in?",
    },
    { role: "user", text: "Yes, quick version." },
    {
      role: "agent",
      text: "Editor: on track, prototype lands Friday. Billing v2: slipped to mid-July for SOC 2 — that’s the one people will poke at. Mobile beta: sequenced after editor, no longer at risk. Two open actions are still unowned from last week — want me to chase them?",
    },
  ],
  ag_scout: [
    {
      role: "agent",
      text: "I pulled the themes across your last 6 customer calls. SSO and granular roles came up in 5 of 6. Want the highlight reel or the verbatim quotes?",
    },
  ],
};

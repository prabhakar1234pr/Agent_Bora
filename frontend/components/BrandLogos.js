/* BrandLogos.js — real, full-color brand marks for integrations.
   Ported from the prototype's brandlogos.jsx. Each entry renders inside a
   neutral white "app icon" tile for a consistent integration-chip look. */
  ...
  slack: {
    ...
    mark: (
      <>
        <path
          fill="#E01E5A"
          d="M5.04 15.12a2.52 2.52 0 1 1-2.52-2.52h2.52v2.52zM6.3 15.12a2.52 2.52 0 0 1 5.04 0v6.3a2.52 2.52 0 0 1-5.04 0v-6.3z"
        />
        <path
          fill="#36C5F0"
          d="M8.82 5.04A2.52 2.52 0 1 1 11.34 2.52v2.52H8.82zM8.82 6.3a2.52 2.52 0 0 1 0 5.04H2.52a2.52 2.52 0 0 1 0-5.04h6.3z"
        />
        <path
          fill="#2EB67D"
          d="M18.96 8.82a2.52 2.52 0 1 1 2.52 2.52h-2.52V8.82zM17.7 8.82a2.52 2.52 0 0 1-5.04 0V2.52a2.52 2.52 0 0 1 5.04 0v6.3z"
        />
        <path
          fill="#ECB22E"
          d="M15.18 18.96a2.52 2.52 0 1 1-2.52 2.52v-2.52h2.52zM15.18 17.7a2.52 2.52 0 0 1 0-5.04h6.3a2.52 2.52 0 0 1 0 5.04h-6.3z"
        />
      </>
    ),
  },
...
const FALLBACK_PLUG = "M9 3v5M15 3v5M6 8h12v3a6 6 0 0 1-12 0V8ZM12 17v4";

export function BrandMark({ id, size = 24 }) {
  const b = BRAND[id];
  if (!b) {
    return (
      <svg
...
export function BrandLogo({ id, size = 40, radius, plain = false }) {
